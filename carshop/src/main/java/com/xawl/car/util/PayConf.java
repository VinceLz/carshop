...
public class PayConf {
	...
	public final static String EZFMER_BACKENDURL = "http://localhost:8080/ezfmp_demo/RecvNotify.action";// 此处为模拟接收清算平台后台发送通知结果的地址，正式投产时需使用清算平台统一分配的地址
	...
	public final static String MERID = "10001"; // 此处为模拟联调商户号，正式投产时需使用清算平台分配的商户号
	public final static String SIGNKEY = "8888888888888";// 此处为模拟联调密钥，正式投产时需使用清算平台分配的密钥
